...
calk.plot.titrant_molinity(
    dbs, figure_fname="figs/LD_storage_test_TA/titrant_molinity.png", show_bad=False
)
calk.plot.alkalinity_offset(
    dbs, figure_fname="figs/LD_storage_test_TA/alkalinity_offset.png", show_bad=False
)
