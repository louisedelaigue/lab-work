...
TA_start = 2212.0
DIC_start = 2012.59
pH_start = pyco2.sys(2212.0, 2012.59, 1, 2, 
                      salinity=33.525,
                      temperature=23,
                      pressure_out=0,
                      opt_pH_scale=3,
...
pH_t0 = pyco2.sys(TA_t0, 2012.59, 1, 2, 
                      salinity=33.525,
                      temperature=23,
                      pressure_out=0,
                      opt_pH_scale=3,
...
pH_end = pyco2.sys(TA_req, pCO2, 1, 4, 
                      salinity=33.525,
                      temperature=23,
                      pressure_out=0,
                      opt_pH_scale=3,
...
TA_target = pyco2.sys(6.3, 2012.59, 3, 2, 
                      salinity=33.525,
                      temperature=23,
                      pressure_out=0,
                      opt_pH_scale=3,
...
TA_sample = 2212.0
TA_mix = pyco2.sys(6.3, 2012.59, 3, 2, 
                      salinity=33.525,
                      temperature=23,
                      pressure_out=0,
                      opt_pH_scale=3,
...
pH_end = pyco2.sys(TA_mix, 416, 1, 4, 
                      salinity=33.525,
                      temperature=23,
                      pressure_out=0,
                      opt_pH_scale=3,
